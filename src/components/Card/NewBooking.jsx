...
const NewBooking = ({
	...
	if (booking.delayDate) {
		let newDate = moment(
			booking.delayDate.seconds * 1000
	...
	return (
		<View style={styles.cardsCover}>
			<Confirm
				...
				title={"Are you sure?"}
				subtitle={
					"Make sure of your payment otherwise you will be penalised!"
				}
				icon={"alert"}
				...
				<View style={styles.cardTop}>
					<View style={styles.cardTopLeft}>
						...
						<View style={{ marginLeft: 20 }}>
							...
							<Text>
								{booking.details.bedrooms}Bedroom,{" "}
								{booking.details.bathrooms} Bathroom
							</Text>
							<Text>
								Extras:{" "}
							...
							{newDispDate && (
								<Text>New Date: {newDispDate}</Text>
							)}
						</View>
					</View>
